(function ($) {
  ...
  /*------------------------------------------
        = GOOGLE MAP
        title: "Shree Mahalaxmi Engineering",
          address1:
            "70/3 ,78, Chirag Industrial Estate, B/H. Revabhai Estate Road, C.T.M .",
          address2: "Ahmedabad, Gujarat, India",
          coords: { lat: 22.9959527, lng: 72.6406272 },
          placeId: "ChIJkXIMVcCHXjkRIlNCrcfMh0k",
    -------------------------------------------*/
  function map() {
    var locations = [
      ["Shree Mahalaxmi Engineering ", 22.9959527, 72.6406272, 1],
    ];

    var map = new google.maps.Map(document.getElementById("map"), {
      center: new google.maps.LatLng(22.9959527, 72.6406272),
      zoom: 12,
      scrollwheel: false,
